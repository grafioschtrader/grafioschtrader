...
test.describe.serial('30: generic connectors — create as alledit, activate as admin', () => {
  ...
  test('activated connectors are offered in the security dialog connector selects', async ({page}) => {
    ...
    test.skip(await watchlistNode.count() === 0, 'Spain watchlist not present (spec 06 not run)');
