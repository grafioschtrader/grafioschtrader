 ...
 *
 * Numbered 067 so that everything the jobs work on already exists: the API keys (005), the currency
 * pairs (035), the instruments (040, 047) and the generic connectors (065). The price update is
