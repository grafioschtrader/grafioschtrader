 ...
 *
 * Numbered 01 so it runs before every other spec (workers: 1, alphabetical order): later specs and
 * background price loading benefit from configured connectors.
 *
...
test.describe.serial('01: connector API keys — created through the admin UI from the local CSV fixture', () => {
