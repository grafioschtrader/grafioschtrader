 ...
 */
@Injectable()
export class TaxYearCorrectionService extends AuthServiceWithLogout<TaxYearCorrection>
  ...
  getBySecurity(idSecuritycurrency: number): Observable<TaxYearCorrectionSecurityInfo> {
    return <Observable<TaxYearCorrectionSecurityInfo>>this.httpClient.get(
