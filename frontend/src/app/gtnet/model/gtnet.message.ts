...
export enum GTNetMessageCodeType {
  ...
  GT_NET_DATA_REQUEST_SEL_C = 20,
  GT_NET_DATA_REQUEST_IN_PROCESS_S = 21,
  GT_NET_DATA_REQUEST_ACCEPT_S = 22,
  GT_NET_DATA_REQUEST_REJECTED_S = 23,
  GT_NET_DATA_REVOKE_SEL_C = 24,
  GT_NET_OFFLINE_ALL_C = 50,
  GT_NET_ONLINE_ALL_C = 51,
  GT_NET_BUSY_ALL_C = 52,
  GT_NET_RELEASED_BUSY_ALL_C = 53,
  GT_NET_MAINTENANCE_ALL_C = 54,
  GT_NET_OPERATION_DISCONTINUED_ALL_C = 55
