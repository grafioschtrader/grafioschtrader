...
/**
 * Old version of GTNetEditComponent. Add or modify a GTNet entity.
 ...
 *
 * @deprecated Use GTNetEditComponent instead, which uses EditableTableComponent for entity configurations.
 */
@Component({
  selector: 'gtnet-edit-old',
  standalone: true,
  imports: [
    DialogModule,
...
export class GTNetEditComponentOld extends SimpleEntityEditBase<GTNet> implements OnInit {
