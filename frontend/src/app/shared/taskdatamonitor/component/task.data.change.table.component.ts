...
@Component({
    template: `
        <div class="data-container" (click)="onComponentClick($event)" #cmDiv
            ...
            <p-table #table [columns]="fields" [value]="taskDataChangeSecurityInfo.taskDataChangeList"
...
export class TaskDataChangeTableComponent extends TableCrudSupportMenu<TaskDataChange> {
    ...
    taskDataChangeSecurityInfo: TaskDataChangeSecurityInfo;
    editMenu: MenuItem;
    ...
    protected override readData(): void {
        combineLatest([this.taskDataChangeService.getAllTaskDataChangeSecurityInfo(), this.taskDataChangeService.getFormConstraints()]).subscribe(data => {
            this.taskDataChangeSecurityInfo = data[0];
            this.tdcFormConstraints = data[1];
            this.prepareTableAndTranslate();
            this.createTranslatedValueStoreAndFilterField(this.taskDataChangeSecurityInfo.taskDataChangeList);
            this.prepareFilter(this.taskDataChangeSecurityInfo.taskDataChangeList);
        });
    }
    ...
    getTooltipValueByPath(dataobject: any, field: ColumnConfig) {
        if (field.field === 'idEntity' && dataobject.entity === 'Security') {
            return this.taskDataChangeSecurityInfo.securityInfo[dataobject['idEntity']];
        } else {
