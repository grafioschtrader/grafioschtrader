...
@NgModule({
  imports: [DynamicFormComponent, DisableControlDirective, NgxErrorsDirective, NgxErrorDirective],
  exports: [DynamicFormComponent, DisableControlDirective, NgxErrorsDirective, NgxErrorDirective]
})
