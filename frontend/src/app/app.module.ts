...
import { SecurityaccountImportTransactionEditHeadComponent } from './imptransaction/component/securityaccount-import-transaction-edit-head.component';
...
import { GTNetImportHeadSelectDialogComponent } from './imptransaction/component/gtnet-import-head-select-dialog.component';
import { SecurityaccountImportTransactionTableComponent } from './imptransaction/component/securityaccount-import-transaction-table.component';
...
import { SecurityaccountImportExtendedInfoFilenameComponent } from './imptransaction/component/securityaccount-import-extended-info-filename.component';
...
import { ConfirmationService, MessageService, SharedModule } from '@openng/optimus-ui/api';
import { AngularSvgIconModule } from 'angular-svg-icon';
import { ProductIconService } from './securitycurrency/service/product.icon.service';
import { SecurityHistoryquotePeriodEditTableComponent } from './shared/securitycurrency/security-historyquote-period-edit-table.component';
...
import { CorrelationSetAddInstrumentTableComponent } from './correlation/component/correlation-set-add-instrument-table.component';
...
import { GTNetMessageEditComponent } from './lib/gnet/component/gtnet-message-edit.component';
...
const createTranslateLoader = (http: HttpClient) =>
  new MultiTranslateHttpLoader(http, [
    {
      prefix: '/api/globalparameters/properties/',
      suffix: '',
      mandatory: true
    }
  ]);
...
@NgModule({
  ...
  imports: [
    ...
    TenantPerformanceEodMissingComponent,
  ...
  providers: [
    ...
    TreeNavigationStateService,
    GlobalparameterGTService,
    GTNetMessageService,
    TabMenuService,
    ReleaseNoteService,
    ...
    GTNetSecurityImpPosService,
    HistoryquotePeriodService,
    HistoryquoteService,
    HistoryquoteLegacyService,
    HoldingService,
    ...
    PortfolioService,
    ProductIconService,
    ProposeChangeEntityService,
    ProposeUserTaskService,
    SecurityaccountService,
    SecurityService,
    SecuritysplitService,
    ...
    TradingDaysMinusService,
    TradingDaysPlusService,
    TradingPlatformPlanService,
    ...
    UDFMetadataSecurityService,
    UDFSpecialTypeDisableUserService,
    UserAdminService,
    UserChartShapeService,
    UserDataService,
    EntityLimitService,
    UserSettingsService,
    ViewSizeChangedService,
    WatchlistService,
    ...
    {
      provide: MAIN_TREE_CONTRIBUTOR,
      useClass: AlgoMainTreeContributor,
      multi: true
    },
    {
      provide: MAIN_TREE_CONTRIBUTOR,
      useClass: WatchlistMainTreeContributor,
      multi: true
    },
    {
      provide: MAIN_TREE_CONTRIBUTOR,
      useClass: BaseDataMainTreeContributor,
      multi: true
    },
    {
      provide: MAIN_TREE_CONTRIBUTOR,
      useClass: AdminDataMainTreeContributor,
      multi: true
    }
  ],
