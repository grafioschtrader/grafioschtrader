 ...
 */
@Injectable()
export class HistoryquoteLegacyService
  extends AuthServiceWithLogout<HistoryquoteLegacy>
  implements ServiceEntityUpdate<HistoryquoteLegacy>, DeleteService
{
  ...
  update(historyquoteLegacy: HistoryquoteLegacy): Observable<HistoryquoteLegacy> {
    return this.updateEntity(
      historyquoteLegacy,
      historyquoteLegacy.idHistoryquoteLegacy,
  ...
  public deleteEntity(idHistoryquoteLegacy: number): Observable<any> {
    return this.httpClient
      .delete(
        `${BaseSettings.API_ENDPOINT}${AppSettings.HISTORYQUOTE_LEGACY_KEY}/${idHistoryquoteLegacy}`,
        this.getHeaders()
      )
  ...
  getLegacyForSecurity(idSecuritycurrency: number): Observable<HistoryquoteLegacy[]> {
    return <Observable<HistoryquoteLegacy[]>>(
      this.httpClient
        .get(
