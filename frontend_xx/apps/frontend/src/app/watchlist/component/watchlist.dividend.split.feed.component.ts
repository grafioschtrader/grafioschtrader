...
export class WatchlistDividendSplitFeedComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    super(
      WatchListType.DIVIDEND_SPLIT_FEDED,
    ...
    this.addColumnFeqH(
      DataType.String,
      'securitycurrency.distributionFrequency',
      true,
      true,
    ...
    this.addColumnFeqH(
      DataType.String,
      'securitycurrency.idConnectorDividend',
      true,
      true,
    ...
    this.addColumnFeqH(
      ...
      'securitycurrency.retryDividendLoad',
      true,
      true
    );
    this.addColumnFeqH(
      DataType.DateNumeric,
      'securitycurrency.dividendEarliestNextCheck',
      true,
      true
    );
    this.addColumnFeqH(
      DataType.String,
      'securitycurrency.idConnectorSplit',
      true,
      true,
      { fieldValueFN: this.getFeedConnectorReadableName.bind(this) }
    );
    this.addColumnFeqH(
      DataType.NumericInteger,
      'securitycurrency.retrySplitLoad',
      true,
      true
    );
