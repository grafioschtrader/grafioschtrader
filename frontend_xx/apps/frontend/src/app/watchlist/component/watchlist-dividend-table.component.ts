...
export class WatchlistDividendTableComponent
  extends DividendSplitTableBase<Dividend>
  implements OnInit
{
  ...
  constructor(
    ...
    super(
      ...
      iconReg,
      'idDividend',
      WatchlistDividendTableComponent.EX_DATE,
  ...
  ngOnInit(): void {
    this.dividendService
      .getDividendsByIdSecuritycurrency(this.idSecuritycurrency)
      .subscribe((dividend) => {
        this.data = dividend;
      });
  }
