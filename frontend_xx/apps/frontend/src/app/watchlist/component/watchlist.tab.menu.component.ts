    ...
    this.items = [
      {
        ...
        command: (event) =>
          this.navigateToRoute(AppSettings.WATCHLIST_PERFORMANCE_KEY, 0),
      },
      {
        label: 'WACHTLIST_PRICE_FEED',
        command: (event) =>
          this.navigateToRoute(AppSettings.WATCHLIST_PRICE_FEED_KEY, 1),
      },
      {
        label: 'WACHTLIST_DIVIDEND_SPLIT_FEED',
        command: (event) =>
          this.navigateToRoute(
            AppSettings.WATCHLIST_DIVIDEND_SPLIT_FEED_KEY,
            2
          ),
      },
    ];
