...
export class CorrelationSetService
  ...
  implements
    DeleteService,
    ServiceEntityUpdate<CorrelationSet>,
    AddSearchToListService<CorrelationSet>
{
  constructor(
      ...
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}` +
            `${AppSettings.CORRELATION_SET_KEY}/tenant`,
          this.getHeaders()
        )
  ...
  getCalculationByCorrelationSet(
  ...
  public deleteEntity(idCorrelationSet: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.CORRELATION_SET_KEY}/` +
          `${idCorrelationSet}`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  ...
  addSecuritycurrenciesToList(
    ...
    return <Observable<CorrelationSet>>(
      this.httpClient
        .put(
          `${AppSettings.API_ENDPOINT}${AppSettings.CORRELATION_SET_KEY}/` +
            `${idCorrelationSet}/addSecuritycurrency`,
  ...
  getCorrelationSetInstrumentLimit(
    idCorrelationSet: number
