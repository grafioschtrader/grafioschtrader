...
@Component({
  ...
  template: ` <p-dialog
    header="{{ 'HISTORY_QUOTE_FOR' | translate }} {{ callParam.showName }}"
...
export class HistoryquoteEditComponent
  extends SimpleEntityEditBase<Historyquote>
  implements OnInit
{
  ...
  constructor(
    ...
    super(
      ...
      AppSettings.HISTORYQUOTE_P_KEY.toUpperCase(),
      translateService,
      gps,
      messageToastService,
      historyquoteService
  ...
  protected override initialize(): void {
    ...
    AuditHelper.configureFormFromAuditableRights(
      ...
      this.gps,
      this.callParam.securitycurrency,
      this.form,
      this.configObject,
  ...
  protected override getNewOrExistingInstanceBeforeSave(value: {
    ...
    this.copyFormToPublicBusinessObject(
      historyquote,
      this.callParam.historyquote,
      this.proposeChangeEntityWithEntity
    );
    historyquote.idSecuritycurrency =
      this.callParam.securitycurrency.idSecuritycurrency;
    return historyquote;
  }
}
