...
export class HistoryquoteQualityFillGapsComponent
  ...
  implements OnInit
{
  ...
  submit(value: { [name: string]: any }): void {
    ...
    this.securityService
      .fillHistoryquoteGapsLinear(
        this.securitycurrency.idSecuritycurrency,
        this.configObject[this.moveWeekendToFriday].formControl.value
      )
      .subscribe(
        (hlfs: HisotryqouteLinearFilledSummary) => {
  ...
  protected initialize(): void {
    ...
    const hasWeekendDays: boolean =
      (this.historyquoteQuality.quoteSaturday !== null &&
        this.historyquoteQuality.quoteSaturday > 0) ||
      (this.historyquoteQuality.quoteSunday !== null &&
        this.historyquoteQuality.quoteSunday > 0);
    this.configObject[this.moveWeekendToFriday].formControl.setValue(
      hasWeekendDays
    );
    !hasWeekendDays &&
      this.configObject[this.moveWeekendToFriday].formControl.disable();
  }
}
