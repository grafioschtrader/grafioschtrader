...
@Component({
  ...
  template: ` <p-dialog
    header="{{ 'DEFINITION' | translate }}: {{
      taEditParam.taIndicators | translate
    }}"
...
export class IndicatorEditComponent
  extends DynamicSimpleEditBase
  implements OnInit
{
  ...
  protected initialize(): void {
    ...
    setTimeout(() =>
      this.form.transferBusinessObjectToForm(
        this.taEditParam.taDynamicDataModel
      )
    );
  }
}
