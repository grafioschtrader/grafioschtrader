...
const APP_ROUTES: Routes = [
  ...
  {
    path: AppSettings.TOKEN_VERIFY_KEY,
    component: RegistrationTokenVerifyComponent,
  },
  {
    path: AppSettings.TENANT_KEY,
    component: TenantEditFullPageComponent,
    canActivate: [AuthGuard],
  },
  {
    path: AppSettings.MAINVIEW_KEY,
    ...
    children: [
      {
        ...
        children: [
          {
            path: AppSettings.PORTFOLIO_KEY,
            component: TenantSummariesCashaccountComponent,
            canActivate: [AuthGuard],
          },
          {
            ...
            children: [
              {
                path: AppSettings.PERFORMANCE_KEY,
          ...
          {
            path: AppSettings.DEPOT_KEY,
            component: TenantSummariesSecurityaccountComponent,
            canActivate: [AuthGuard],
          },
          {
            path: AppSettings.DEPOT_CASH_KEY,
            component: TenantSummariesAssetclassComponent,
            canActivate: [AuthGuard],
          },
          {
            path: AppSettings.DIVIDENDS_ROUTER_KEY,
            component: TenantDividendsComponent,
            canActivate: [AuthGuard],
          },
          {
      ...
      },
      {
        ...
        component: HistoryquoteTableComponent,
        outlet: AppSettings.MAIN_BOTTOM,
        canActivate: [AuthGuard],
      },
      {
        path: AppSettings.MAIL_SHOW_MESSAGE_KEY,
        component: MailMessageComponent,
        outlet: AppSettings.MAIN_BOTTOM,
        canActivate: [AuthGuard],
      },
      {
        path: AppSettings.STRATEGY_OVERVIEW_KEY,
        component: StrategyOverviewComponent,
        canActivate: [AuthGuard],
      },
      {
        path: AppSettings.ALGO_TOP_KEY + '/:id',
        component: AlgoTopDataViewComponent,
        canActivate: [AuthGuard],
      },
      {
        path: AppSettings.WATCHLIST_KEY + '/:id',
      ...
      // Base data
      {
        path: AppSettings.ASSETCLASS_KEY,
        component: AssetclassTableComponent,
        canActivate: [AuthGuard],
      },
      {
      ...
      // Admin data
      {
        ...
        component: MailInOutTabMenuComponent,
        canActivate: [AuthGuard],
        children: [
          {
            path: AppSettings.MAIL_INBOX_KEY,
            component: MailInboxTableComponent,
            canActivate: [AuthGuard],
          },
          {
            path: AppSettings.MAIL_SENDBOX_KEY,
            component: MailSendboxTableComponent,
            canActivate: [AuthGuard],
          },
        ],
      },
      ...
      {
        path: AppSettings.CONNECTOR_API_KEY_KEY,
        component: ConnectorApiKeyTableComponent,
        canActivate: [AdminGuard],
      },
      {
        path: AppSettings.USER_ENTITY_LIMIT_KEY,
