...
@Component({
  ...
  template: `
    <password-edit
      *ngIf="mainDialogService.visibleDialogs[UserSettingsDialogs.Password]"
      [visibleDialog]="
        mainDialogService.visibleDialogs[UserSettingsDialogs.Password]
      "
    >
    </password-edit>
    <nickname-lang-edit
      *ngIf="
        mainDialogService.visibleDialogs[UserSettingsDialogs.NicknameLocale]
      "
      [visibleDialog]="
        mainDialogService.visibleDialogs[UserSettingsDialogs.NicknameLocale]
      "
