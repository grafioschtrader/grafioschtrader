  ...
  implements ServiceEntityUpdate<TaskDataChange>, DeleteService
{
  ...
  getAllTaskDataChange(): Observable<TaskDataChange[]> {
    return <Observable<TaskDataChange[]>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.TASK_DATA_CHANGE_KEY}`,
          this.getHeaders()
        )
  ...
  update(taskDataChange: TaskDataChange): Observable<TaskDataChange> {
    return this.updateEntity(
      taskDataChange,
      taskDataChange.idTaskDataChange,
      AppSettings.TASK_DATA_CHANGE_KEY
    );
  }
  ...
  deleteEntity(idTaskDataChange: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.TASK_DATA_CHANGE_KEY}/${idTaskDataChange}`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  }
  ...
  interruptingRunningJob(idTaskDataChange: number): Observable<boolean> {
    return this.httpClient
      .patch(
        `${AppSettings.API_ENDPOINT}${AppSettings.TASK_DATA_CHANGE_KEY}/interruptingrunningjob` +
          `/${idTaskDataChange}`,
        null,
        this.getHeaders()
      )
