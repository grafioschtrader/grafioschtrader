...
export class GlobalSettingsEditComponent
  extends SimpleEntityEditBase<Globalparameters>
  implements OnInit
{
  ...
  private getPropertyDefinition(
    ...
    if (globalparameters.propertyDate) {
      ...
      return DynamicFieldHelper.createFieldPcalendar(
        DataType.DateString,
      ...
      return DynamicFieldHelper.createFieldInputString(
        this.selectedPropertyField,
        globalparameters.propertyName,
        30,
        true
