...
export class ParentChildRegisterService {
  ...
  public callChildrenToPreserve(data: any) {
    this.childPreservePages.forEach((childPreservePage) =>
      childPreservePage.preservePage(data)
    );
  }
  ...
  public getRowPostion(id: number): PageFirstRowSelectedRow {
    ...
    return pageFirstRowSelectedRow
      ? pageFirstRowSelectedRow
      : new PageFirstRowSelectedRow(0, null);
  }
}
