...
export class AppSettings {
  ...
  public static readonly IMPORT_TRANSACTION_PLATFORM =
    'ImportTransactionPlatform';
  public static readonly IMPORT_TRANSACTION_POS = 'ImportTransactionPos';
  public static readonly IMPORT_TRANSACTION_TEMPLATE =
  ...
  public static readonly ALGO_ASSETCLASS_KEY =
    AppSettings.ALGO_ASSETCLASS.toLowerCase();
  public static readonly ALGO_SECURITY_KEY =
    AppSettings.ALGO_SECURITY.toLowerCase();
  public static readonly ALGO_STRATEGY_KEY =
    AppSettings.ALGO_STRATEGY.toLowerCase();
  ...
  public static readonly SECURITY_DIVIDEND_KEY =
    AppSettings.DIVIDEND.toLowerCase();
  public static readonly MAIL_INBOX_KEY = AppSettings.MAIL_INBOX.toLowerCase();
  public static readonly MAIL_SENDBOX_KEY =
    AppSettings.MAIL_SENDBOX.toLowerCase();
  ...
  public static readonly WATCHLIST_DIVIDEND_SPLIT_FEED_KEY =
    'watchlistdividendsplitfeed';
  public static readonly TRANSACTION_KEY =
    AppSettings.TRANSACTION.toLowerCase();
  ...
  public static readonly STOCKEXCHANGE_KEY =
    AppSettings.STOCKEXCHANGE.toLowerCase();
  public static readonly SECURITY_KEY = AppSettings.SECURITY.toLowerCase();
  public static readonly SECURITY_SPLIT_KEY =
    AppSettings.SECURITY_SPLIT.toLowerCase();
  public static readonly SECURITYACCOUNT_KEY =
    AppSettings.SECURITYACCOUNT.toLowerCase();
  ...
  public static readonly TRADING_DAYS_MINUS_KEY =
    AppSettings.TRADING_DAYS_MINUS.toLowerCase();
  public static readonly TRADING_DAYS_PLUS_KEY =
    AppSettings.TRADING_DAYS_PLUS.toLowerCase();
  public static readonly IMPORT_TRANSACTION_HEAD_KEY =
    AppSettings.IMPORT_TRANSACTION_HEAD.toLowerCase();
  public static readonly IMPORT_TRANSACTION_POS_KEY =
    AppSettings.IMPORT_TRANSACTION_POS.toLowerCase();
  public static readonly TRADING_PLATFORM_PLAN_KEY =
    AppSettings.TRADING_PLATFORM_PLAN.toLowerCase();
  public static readonly IMP_TRANS_PLATFORM_KEY =
    AppSettings.IMPORT_TRANSACTION_PLATFORM.toLowerCase();
  public static readonly IMP_TRANS_TEMPLATE_KEY =
    AppSettings.IMPORT_TRANSACTION_TEMPLATE.toLowerCase();
  public static readonly CASHACCOUNT_KEY =
    AppSettings.CASHACCOUNT.toLowerCase();
  public static readonly CURRENCYPAIR_KEY =
    AppSettings.CURRENCYPAIR.toLowerCase();
  public static readonly CURRENCY_KEY = 'currency';
  public static readonly PORTFOLIO_KEY = AppSettings.PORTFOLIO.toLowerCase();
  public static readonly PROPOSE_CHANGE_ENTITY_KEY =
    AppSettings.PROPOSE_CHANGE_ENTITY.toLowerCase();
  public static readonly PROPOSE_CHANGE_YOUR_PROPOSAL_KEY =
    'proposeyourproposal';
  public static readonly PROPOSE_CHANGE_REQUEST_FOR_YOU_KEY =
    'proposerequestforyou';
  ...
  public static readonly HISTORYQUOTE_KEY =
    AppSettings.HISTORYQUOTE.toLowerCase();
  public static readonly HISTORYQUOTE_P_KEY =
    AppSettings.HISTORYQUOTE_KEY + 's';
  public static readonly HISTORYQUOTE_PERIOD_KEY =
    AppSettings.HISTORYQUOTE_PERIOD.toLowerCase();
  public static readonly GLOBALPARAMETERS_P_KEY =
    AppSettings.GLOBALPARAMETERS.toLowerCase();
  ...
  public static readonly USER_ENTITY_LIMIT_KEY =
    AppSettings.USER_ENTITY_LIMIT.toLowerCase();
  public static readonly PROPOSE_USER_TASK_KEY =
    AppSettings.PROPOSE_USER_TASK.toLowerCase();
  ...
  public static readonly SECURITYACCOUNT_TAB_MENU_KEY =
    'securityaccountTabMenu';
  ...
  public static readonly SECURITYACCOUNT_SUMMERY_ROUTE_KEY =
    'securityaccountSummery';

  public static readonly SECURITYACCOUNT_EMPTY_ROUTE_KEY =
    'securityaccountEmpty';
  public static readonly SECURITYACCOUNT_SUMMERIES_ROUTE_KEY =
    'securityaccountSummeries';
  ...
  // HELP Support
  public static readonly HELP_DOMAIN =
    '//grafioschtrader.github.io/gt-user-manual/';
  ...
  public static readonly WATCHLIST_PERFORMANCE_TABLE_SETTINGS_STORE =
    'u_watchlist_performance_3';
  public static readonly WATCHLIST_PRICE_FEED_TABLE_SETTINGS_STORE =
    'u_watchlist_price_feed_3';
  public static readonly WATCHLIST_DIVIDEND_SPLIT_FEED_TABLE_SETTINGS_STORE =
    'u_watchlist_dividend_split_feed_4';
  public static readonly IMPORT_TRANSACTION_POS_TABLE_SETTINGS_STORE =
    'u_importtransactionpos_2';
  public static readonly HISTORYQUOTE_TABLE_SETTINGS_STORE =
    'u_historyquote_01';
  ...
  public static readonly HIST_SUPPORTED_CSV_FORMAT =
    'hist_supported_csv_format';

  static readonly PATH_ASSET_ICONS = 'assets/icons/';

  // Some definitions of property names which are used in more than one class
  public static readonly VALUE_SECURITY_MAIN_CURRENCY_FIELD =
    'accountValueSecurityMC';
  public static readonly SUCCESS_FAILED_IMP_TRANS =
    'successFailedDirectImpTran';
  ...
  public static resetInterFractionLimit(): void {
    const standardPrecisionMap: { [typename: string]: number } = JSON.parse(
      sessionStorage.getItem(GlobalSessionNames.STANDARD_PRECISION)
    );
