...
export class ChartGeneralPurposeComponent
  implements OnInit, OnDestroy, IGlobalMenuAttach
{
  ...
  ngOnInit(): void {
    ...
    this.subscriptionChartDataChanged =
      this.chartDataService.chartDataChanged$.subscribe(
        (chartData: ChartData) => {
  ...
  ngOnDestroy(): void {
    ...
    this.subscriptionChartDataChanged &&
      this.subscriptionChartDataChanged.unsubscribe();
    this.subscriptionViewSizeChanged &&
  ...
  private attachTooltip(): void {
    PlotlyHelper.attachTooltip(
      Plotly,
      this.chartData.legendTooltipMap,
      this.chartElement
    );
  }
}
