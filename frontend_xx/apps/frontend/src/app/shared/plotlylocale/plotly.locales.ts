  ...
  public static readonly PLOTY_LOCALES = [
    {
      ...
      dictionary: {
        ...
        'Click to enter Colorscale title':
          'Klicken, um den Farbskalatitel einzugeben',
        'Click to enter Component A title':
          'Klicken, um den Titel der Komponente A einzugeben',
        'Click to enter Component B title':
          'Klicken, um den Titel der Komponente B einzugeben',
        'Click to enter Component C title':
          'Klicken, um den Titel der Komponente C einzugeben',
        'Click to enter Plot title':
          'Klicken, um den Titel des Graphen einzugeben',
        'Click to enter X axis title':
          'Klicken, um den Titel der X-Achse einzugeben',
        'Click to enter Y axis title':
          'Klicken, um den Titel der Y-Achse einzugeben',
        ...
        'Reset camera to last save':
          'Kamera auf letzte Speicherung zurücksetzen',
