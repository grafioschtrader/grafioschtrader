...
@Component({
  ...
  template: ` <p-dialog
    header="{{ 'PASSWORD_CHANGE' | translate }}"
  ...
  implements OnInit, AfterViewInit
{
  ...
  ngOnInit(): void {
    this.changePasswdFormDefinition(
      JSON.parse(
        sessionStorage.getItem(GlobalSessionNames.USER_FORM_DEFINITION)
      )
    );
  }
