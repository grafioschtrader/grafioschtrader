  ...
  template: `
    ...
    >
      <div class="datatable nestedtable">
        <p-table
          [columns]="fields"
          [value]="transactionCostPositions"
          selectionMode="single"
          [(selection)]="baseSelectedRow"
          #dataTable
          [first]="firstRowIndex"
...
export class TenantTransactionCostExtendedComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  ngOnInit(): void {
    ...
    this.addColumn(
      DataType.String,
      'transaction.security.stockexchange.name',
    ...
    this.addColumn(
      DataType.String,
      'transaction.cashaccount.currency',
      'CURRENCY_CASHACCOUNT',
      true,
      false
    );
    this.addColumn(
    ...
    this.addColumn(
      DataType.Numeric,
      'basePriceForTransactionCostMC',
      'NETTO_VALUE_TRANSACTION',
      true,
      false,
      { headerSuffix: this.transactionCostGrandSummary.mainCurrency }
    );
  ...
  protected getMenuItemsOnTransaction(transaction: Transaction): MenuItem[] {
    ...
    return super
      .getMenuItemsOnTransaction(transaction)
      .concat(localContextMenu);
  }
