    ...
    >
      ...
      <ng-template pTemplate="body" let-el let-columns="fields">
        <tr
          [pSelectableRow]="el"
          [ngClass]="
            selectedDayIdSecurities.indexOf(el.idSecuritycurrency) >= 0
              ? 'rowgroup-total'
              : null
          "
        >
...
export class TenantPerformanceEodMissingTableComponent
    ...
    this.securityService
      ...
      .subscribe(
        (feedConnectors: IFeedConnector[]) =>
          (this.feedConnectorsKV = Object.assign(
            {},
            ...feedConnectors.map((feedConnector) => ({
