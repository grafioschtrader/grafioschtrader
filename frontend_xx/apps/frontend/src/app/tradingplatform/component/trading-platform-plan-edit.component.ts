...
@Component({
  ...
  template: ` <p-dialog
    header="{{ 'TRADINGPLATFORMPLAN' | translate }}"
...
export class TradingPlatformPlanEditComponent
  extends SimpleEntityEditBase<TradingPlatformPlan>
  implements OnInit
{
  ...
  constructor(
    ...
    super(
      HelpIds.HELP_BASEDATA_TRADING_PLATFORM_PLAN,
  ...
  protected override getNewOrExistingInstanceBeforeSave(value: {
    ...
    */
    ...
    tradingPlatformPlan.importTransactionPlatform =
      this.importTransactionPlatformList.find(
        (importTransactionPlatform) =>
          importTransactionPlatform.idTransactionImportPlatform ===
          +value.idTransactionImportPlatform
      );
    const values: any = {};
