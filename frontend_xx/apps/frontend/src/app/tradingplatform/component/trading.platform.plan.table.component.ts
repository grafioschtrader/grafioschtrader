...
export class TradingPlatformPlanTableComponent
  extends TableCrudSupportMenu<TradingPlatformPlan>
  implements OnDestroy
{
  ...
  constructor(
    ...
    this.addColumn(
      DataType.String,
      'importTransactionPlatform.name',
