  ...
  template: `
    ...
    <div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
      <button
        ...
        [label]="'ASSIGN_SELECTED' | translate"
        (click)="chooseSecurity()"
        type="button"
      ></button>
    </div>
  `,
...
export class SecuritycurrencySearchAndSetTableComponent extends SecuritycurrencySearchTableBase {
  ...
  loadData(securitycurrencySearch: SecuritycurrencySearch): void {
    securitycurrencySearch.excludeDerivedSecurity =
      this.supplementCriteria.excludeDerivedSecurity;
    ...
    !this.supplementCriteria.onlySecurity &&
      obs.push(
        this.currencypairService.searchByCriteria(securitycurrencySearch)
      );
