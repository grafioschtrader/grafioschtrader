...
export class SecuritycurrencySearchAndSetComponent
  extends SecuritycurrencySearchBase
  implements CallBackSetSecurity, AfterSetSecurity
{
  // From parent view
  ...
  @ViewChild(SecuritycurrencySearchAndSetTableComponent)
  sissdc: SecuritycurrencySearchAndSetTableComponent;
