...
@Component({
  selector: 'user-edit',
  template: ` <p-dialog
    header="{{ 'USER_SETTINGS' | translate }}"
...
export class UserEditComponent
  extends SimpleEntityEditBase<User>
  implements OnInit
{
  ...
  protected initialize(): void {
    ...
    const proposeChangeEntityWithEntity: ProposeChangeEntityWithEntity =
      AuditHelper.convertToProposeChangeEntityWithEntity(
        this.callParam,
        this.callParam.userChangePropose
      );
    this.configObject.mostPrivilegedRole.valueKeyHtmlOptions =
      SelectOptionsHelper.translateArrayKeyEqualValue(this.translateService, [
        AppSettings.ROLE_LIMIT_EDIT,
        AppSettings.ROLE_USER,
