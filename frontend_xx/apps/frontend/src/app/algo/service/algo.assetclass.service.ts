...
export class AlgoAssetclassService
  ...
  implements DeleteService, ServiceEntityUpdate<AlgoAssetclass>
{
  constructor(
  ...
  getAlgoAssetclassByIdTenantAndIdAlgoAssetclassParent(
    ...
    return <Observable<AlgoAssetclass[]>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ALGO_ASSETCLASS_KEY}` +
  ...
  public update(algoAssetclass: AlgoAssetclass): Observable<AlgoAssetclass> {
    return this.updateEntity(
      algoAssetclass,
      algoAssetclass.idAlgoAssetclassSecurity,
      AppSettings.ALGO_ASSETCLASS_KEY
    );
  }
  ...
  public deleteEntity(idAlgoAssetclassSecurity: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.ALGO_ASSETCLASS_KEY}/${idAlgoAssetclassSecurity}`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  }
