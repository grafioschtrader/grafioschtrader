  ...
  implements DeleteService, ServiceEntityUpdate<AlgoTop>
{
  ...
  getAlgoTopByIdTenantOrderByName(): Observable<AlgoTop[]> {
    return <Observable<AlgoTop[]>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ALGO_TOP_KEY}/${AppSettings.TENANT_KEY}`,
          this.getHeaders()
        )
  ...
  getAlgoTopByIdAlgoAssetclassSecurity(
    ...
    return <Observable<AlgoTop>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ALGO_TOP_KEY}/${idAlgoAssetclassSecurity}`,
          this.getHeaders()
        )
        .pipe(catchError(this.handleError.bind(this)))
    );
  ...
  public create(algoTopCreate: AlgoTopCreate): Observable<AlgoTop> {
    return <Observable<AlgoTop>>(
      this.httpClient
        .post(
          `${AppSettings.API_ENDPOINT}${AppSettings.ALGO_TOP_KEY}/create`,
          algoTopCreate,
