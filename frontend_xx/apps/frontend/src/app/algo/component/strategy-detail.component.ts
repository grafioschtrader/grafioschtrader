  ...
  implements OnChanges
{
  ...
  ngOnChanges() {
    console.log(
      'ngOnInit-AlgoStrategy:',
      this.algoStrategyParamCall.algoStrategy
    );
    console.log(
    ...
    this.createDynamicOutputFields(
      this.algoStrategyParamCall.fieldDescriptorShow
    );
  ...
  private createDynamicOutputFields(
    ...
    fieldDescriptorInputAndShows.forEach((fDIAS) => {
      ...
      this.addFieldProperty(
        ...
        AppSettings.PREFIX_ALGO_FIELD +
          AppHelper.convertPropertyNameToUppercase(fDIAS.fieldName),
        optinalParams
      );
    });
  }
