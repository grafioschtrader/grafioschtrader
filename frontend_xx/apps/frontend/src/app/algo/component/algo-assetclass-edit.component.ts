...
export class AlgoAssetclassEditComponent
  extends AlgoAssetclassSecurityBaseEdit<AlgoAssetclass>
  implements OnInit
{
  constructor(
  ...
  protected initialize(): void {
    ...
    combineLatest([
      this.getAssetclassObserver(),
      allSecurityaccountsObservable,
    ]).subscribe((data: [Assetclass | Assetclass[], Portfolio[]]) => {
      this.configObject.assetclass.referencedDataObject = Array.isArray(data[0])
        ? data[0]
        : [data[0]];
