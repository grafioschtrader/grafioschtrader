...
export class MailSendboxTableComponent
  extends MailInOutTable<MailSendbox>
  implements OnDestroy
{
  constructor(
    private mailSendboxService: MailSendboxService,
    router: Router,
    ...
    this.addColumnFeqH(DataType.DateTimeString, 'sendTime', true, false, {
      width: 80,
    });
