...
@Component({
  ...
  template: `
    <p-dialog
      header="{{ 'CHANGE_TO_ACCOUNT_TRANSFER' | translate }}"
...
export class TransactionCashaccountConnectDebitCreditComponent
  ...
  implements OnInit
{
  ...
  ngOnInit(): void {
    this.config = [FormDefinitionHelper.getTransactionTime()];
  }
