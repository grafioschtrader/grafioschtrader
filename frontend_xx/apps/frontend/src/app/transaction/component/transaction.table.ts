...
export abstract class TransactionTable extends TransactionContextMenu {
  ...
  handleCloseTransactionDialog(processedActionData: ProcessedActionData) {
    ...
    processedActionData.action !== ProcessedAction.NO_CHANGE &&
      this.initialize();
  }
  ...
  protected addCurrencypairToTransaction(
    ...
    for (const transaction of transactions) {
      if (transaction.idCurrencypair != null) {
        transaction.currencypair = currencypairMap.get(
  ...
  protected override prepareTransactionCallParam(
