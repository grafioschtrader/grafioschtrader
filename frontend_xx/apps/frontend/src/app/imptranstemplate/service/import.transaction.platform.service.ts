  ...
  implements DeleteService, ServiceEntityUpdate<ImportTransactionPlatform>
{
  ...
  ): Observable<ImportTransactionPlatform> {
  ...
  public deleteEntity(idTransactionImportPlatform: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMP_TRANS_PLATFORM_KEY}/` +
  ...
  uploadAndTransformPDFToTxt(pdfFileToUpload: File): Observable<string> {
    ...
    return <Observable<string>>(
      this.httpClient
        .post(
          `${AppSettings.API_ENDPOINT}${AppSettings.IMP_TRANS_PLATFORM_KEY}/transformpdftotxt`,
          formData,
          options
        )
        .pipe(catchError(this.handleError.bind(this)))
