  ...
  implements DeleteService, ServiceEntityUpdate<ImportTransactionTemplate>
{
  ...
  public deleteEntity(idTransactionImportTemplate: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMP_TRANS_TEMPLATE_KEY}/${idTransactionImportTemplate}`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  }
  ...
  checkFormAgainstTemplate(
    formTemplateCheck: FormTemplateCheck
  ): Observable<FormTemplateCheck> {
  ...
  public async getTemplatesByPlatformPlanAsZip(
    idTradingPlatformPlan: number
  ): Promise<Blob> {
    return await this.httpClient
      .get<Blob>(
        ...
        {
          headers: this.prepareHeaders('application/zip'),
  ...
  public uploadImportTemplateFiles(
    ...
    return this.httpClient
      .post(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMP_TRANS_TEMPLATE_KEY}` +
