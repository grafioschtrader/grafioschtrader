  ...
  >
    ...
    <ng-container *ngIf="formTemplateCheck">
      <template-form-check-dialog-result-success
        *ngIf="formTemplateCheck.importTransactionPos"
        [formTemplateCheck]="formTemplateCheck"
      >
      </template-form-check-dialog-result-success>

      <template-form-check-dialog-result-failed
        *ngIf="formTemplateCheck.failedParsedTemplateStateList"
        [failedParsedTemplateStateList]="
          formTemplateCheck.failedParsedTemplateStateList
        "
      >
      </template-form-check-dialog-result-failed>
    </ng-container>
...
export class TemplateFormCheckDialogComponent
  ...
  implements OnInit
{
  ...
  ngOnInit(): void {
    ...
    this.config = [
      ...
      DynamicFieldHelper.createFunctionButton('CHECK_TEMPLATE_FORM', (e) =>
        this.checkFormAgainstTemplate(e)
      ),
  ...
  checkFormAgainstTemplate(event) {
    ...
    this.importTransactionTemplateService
      .checkFormAgainstTemplate(ftc)
      .subscribe((formTemplateCheck) => {
