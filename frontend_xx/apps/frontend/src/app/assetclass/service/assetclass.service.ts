  ...
  implements DeleteService, ServiceEntityUpdate<Assetclass>
{
  ...
  public getAllAssetclass(): Observable<Assetclass[]> {
    return <Observable<Assetclass[]>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ASSETCLASS_KEY}`,
          this.getHeaders()
        )
  ...
  public getInvestableAssetclassesByWatchlist(
    idWatchlist: number
  ...
  public getPossibleAssetclassInstrumentMap(): Observable<{
    [key in AssetclassType]: SpecialInvestmentInstruments[];
  }> {
    return <
      Observable<{ [key in AssetclassType]: SpecialInvestmentInstruments[] }>
    >this.httpClient
      .get(
        `${AppSettings.API_ENDPOINT}${AppSettings.ASSETCLASS_KEY}/possibleassetclassspezinstrument`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  }
  ...
  public getAssetclass(idAssetclass: number): Observable<Assetclass> {
    return <Observable<Assetclass>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ASSETCLASS_KEY}/${idAssetclass}`,
          this.getHeaders()
        )
        .pipe(catchError(this.handleError.bind(this)))
    );
  ...
  public getUnusedAssetclassForAlgo(
  ...
  public assetclassesHasSecurity(): Observable<number[]> {
    return <Observable<number[]>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ASSETCLASS_KEY}/hassecurity`,
          this.getHeaders()
        )
        .pipe(catchError(this.handleError.bind(this)))
    );
  ...
  public assetclassHasSecurity(idAssetclass: number): Observable<boolean> {
    return <Observable<boolean>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ASSETCLASS_KEY}/${idAssetclass}/hassecurity`,
          this.getHeaders()
        )
        .pipe(catchError(this.handleError.bind(this)))
    );
  ...
  public getSubcategoryForLanguage(): Observable<ValueKeyHtmlSelectOptions[]> {
    return <Observable<ValueKeyHtmlSelectOptions[]>>(
      this.httpClient
        .get(
          `${AppSettings.API_ENDPOINT}${AppSettings.ASSETCLASS_KEY}/subcategory`,
          this.getHeaders()
        )
        .pipe(catchError(this.handleError.bind(this)))
    );
