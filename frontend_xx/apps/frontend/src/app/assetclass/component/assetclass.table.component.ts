...
export class AssetclassTableComponent
  extends TableCrudSupportMenuSecurity<Assetclass>
  implements OnDestroy
{
  ...
  constructor(
    ...
    this.addColumn(
      ...
      false,
      {
        fieldValueFN: this.getAssetclassIcon.bind(this),
        templateName: 'icon',
        width: 25,
      }
    );
  ...
  readData(): void {
    combineLatest([
      ...
      this.assetclassService.assetclassesHasSecurity(),
    ]).subscribe((data) => {
