...
export class Security extends Securitycurrency implements BaseID {
  ...
  public static canHaveSplitConnector(
    ...
    return hasMarketValue && assetClass
      ? !(
          ...
          (assetClass.specialInvestmentInstrument ===
            ...
            assetClass.specialInvestmentInstrument ===
              SpecialInvestmentInstruments[
                SpecialInvestmentInstruments.MUTUAL_FUND
              ] ||
            assetClass.specialInvestmentInstrument ===
  ...
  public static canHaveDividendConnector(
    ...
    if (hasMarketValue && assetClass) {
      ...
      if (
        ...
        distributionFrequency !== DistributionFrequency.DF_NONE
      ) {
        canHaveDividend =
          assetClass.specialInvestmentInstrument ===
            SpecialInvestmentInstruments[SpecialInvestmentInstruments.ETF] ||
          assetClass.specialInvestmentInstrument ===
            SpecialInvestmentInstruments[
              SpecialInvestmentInstruments.PENSION_FUNDS
            ] ||
          assetClass.specialInvestmentInstrument ===
            SpecialInvestmentInstruments[
              SpecialInvestmentInstruments.MUTUAL_FUND
