  ...
  implements ServiceEntityUpdate<Stockexchange>, DeleteService
{
  ...
  public getAllStockexchanges(
    includeNameOfCalendarIndex: boolean
  ): Observable<Stockexchange[]> {
    return <Observable<Stockexchange[]>>this.httpClient
      .get(`${AppSettings.API_ENDPOINT}${AppSettings.STOCKEXCHANGE_KEY}`, {
        headers: this.prepareHeaders(),
        params: new HttpParams().set(
          'includeNameOfCalendarIndex',
  ...
  public stockexchangeHasSecurity(
  ...
  deleteEntity(idStockexchange: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.STOCKEXCHANGE_KEY}/${idStockexchange}`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  }
