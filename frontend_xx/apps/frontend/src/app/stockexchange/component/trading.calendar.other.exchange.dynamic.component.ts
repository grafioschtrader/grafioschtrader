...
import {
  CopyTradingDaysFromSourceToTarget,
  TradingDaysMinusService,
} from '../service/trading.days.minus.service';
...
export class TradingCalendarOtherExchangeDynamicComponent
  extends FormBase
  implements OnInit
{
  ...
  ngOnInit(): void {
    ...
    this.configObject[this.NAME].valueKeyHtmlOptions =
      this.dynamicDialogConfig.data.sourceCopyStockexchanges;
    this.copyTradingDaysFromSourceToTarget =
      this.dynamicDialogConfig.data.copyTradingDaysFromSourceToTarget;
    this.configObject[this.YEAR_OR_FULL_PROP].defaultValue = this
      .copyTradingDaysFromSourceToTarget.fullCopy
  ...
  submit(value: { [name: string]: any }): void {
    ...
    this.tradingDaysMinusService
      .copyAllTradingDaysMinusToOtherStockexchange(
        this.copyTradingDaysFromSourceToTarget
      )
      .subscribe(
