  ...
  implements DeleteService, ServiceEntityUpdate<ImportTransactionPos>
{
  ...
  public deleteEntity(idTransactionImportPos: number): Observable<any> {
    return this.httpClient
      .delete(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMPORT_TRANSACTION_POS_KEY}/${idTransactionImportPos}`,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  }
  ...
  public adjustQuotation(idTransactionPosList: number[]): Observable<any> {
    return this.httpClient
      .post(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMPORT_TRANSACTION_POS_KEY}/adjustquotation`,
  ...
  public adjustCurrencyExRateOrQuotation(
    idTransactionPosList: number[]
  ): Observable<any> {
    return this.httpClient
      .post(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMPORT_TRANSACTION_POS_KEY}/adjustcurrencyexrateorquotation`,
        idTransactionPosList,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  ...
  public acceptTotalDiff(idTransactionPosList: number[]): Observable<any> {
    return this.httpClient
      .post(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMPORT_TRANSACTION_POS_KEY}/accepttotaldiff`,
        idTransactionPosList,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  ...
  public deleteMultiple(idTransactionPosList: number[]): Observable<any> {
    return this.httpClient
      .post(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMPORT_TRANSACTION_POS_KEY}/deletes`,
        idTransactionPosList,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
  ...
  public createAndSaveTransactions(
    idTransactionPosList: number[]
  ): Observable<any> {
    return this.httpClient
      .post(
        `${AppSettings.API_ENDPOINT}${AppSettings.IMPORT_TRANSACTION_POS_KEY}/createtransaction`,
        idTransactionPosList,
        this.getHeaders()
      )
      .pipe(catchError(this.handleError.bind(this)));
