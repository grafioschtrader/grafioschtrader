...
export class SecurityaccountImportExtendedInfoComponent
  ...
  implements OnInit
{
  ...
  ngOnInit(): void {
    ...
    this.addFieldProperty(
      DataType.String,
      ImportSettings.IMPORT_TRANSACTION_POS + 'securityNameImp',
      'NAME',
      { fieldsetName: this.IMPORT_VALUE }
    );
    ...
    this.addFieldPropertyFeqH(
      DataType.Boolean,
      ImportSettings.IMPORT_TRANSACTION_POS + 'taxableInterest',
      { fieldsetName: this.IMPORT_VALUE, templateName: 'check' }
    );
    this.addFieldProperty(
      DataType.String,
      ImportSettings.IMPORT_TRANSACTION_POS + 'currencySecurity',
      'SECURITY_CURRENCY',
      { fieldsetName: this.IMPORT_VALUE }
    );
    this.addFieldProperty(
    ...
    this.addFieldPropertyFeqH(
      DataType.Numeric,
      ImportSettings.IMPORT_TRANSACTION_POS + 'accruedInterest',
      { fieldsetName: this.IMPORT_VALUE }
    );
    this.addFieldPropertyFeqH(
      DataType.Numeric,
      ImportSettings.IMPORT_TRANSACTION_POS + 'taxCost',
      { fieldsetName: this.IMPORT_VALUE }
    );
    this.addFieldPropertyFeqH(
      DataType.Numeric,
      ImportSettings.IMPORT_TRANSACTION_POS + 'transactionCost',
      { fieldsetName: this.IMPORT_VALUE }
    );
    this.addFieldProperty(
      DataType.Numeric,
      ImportSettings.IMPORT_TRANSACTION_POS + 'cashaccountAmount',
      'TOTAL_AMOUNT',
      { fieldsetName: this.IMPORT_VALUE }
    );
    this.addFieldProperty(
    ...
    this.addFieldProperty(
      DataType.Numeric,
      ImportSettings.IMPORT_TRANSACTION_POS + 'calcCashaccountAmount',
      'CALC_TOTAL_VALUE',
      { fieldsetName: this.IMPORT_ASSIGN }
    );
    this.addFieldPropertyFeqH(
    ...
    this.addFieldPropertyFeqH(
      DataType.String,
      ImportSettings.IMPORT_TRANSACTION_POS + 'fileNameOriginal',
      { fieldsetName: AppSettings.IMPORT_TRANSACTION_TEMPLATE.toUpperCase() }
    );
    this.addFieldPropertyFeqH(
      DataType.Numeric,
    ...
    this.addFieldProperty(
      DataType.String,
      ImportSettings.IMPORT_TRANSACTION_POS + 'transactionError',
      null,
