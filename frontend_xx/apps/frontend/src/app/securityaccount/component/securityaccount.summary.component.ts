...
export class SecurityaccountSummaryComponent
  extends SecurityaccountTable
  implements OnInit, OnDestroy
{
  ...
  public dropped(files: NgxFileDropEntry[]): void {
    AppHelper.processDroppedFiles(
      ...
      'pdf',
      this.uploadTransactionFiles.bind(this)
    );
  }

  protected extendTransactionParamData(
          ...
          this.ngZone
            .run(() =>
              this.router.navigate([
                `${AppSettings.MAINVIEW_KEY}/${AppSettings.SECURITYACCOUNT_TAB_MENU_KEY}`,
                this.idSecurityaccount,
                data,
              ])
            )
