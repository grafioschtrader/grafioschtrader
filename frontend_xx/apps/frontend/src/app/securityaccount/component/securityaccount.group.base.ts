...
> {
  ...
  public abstract getGroupValueFromGroupRow(
    securityPositionGroupSummary: T
  ): any;

  public abstract getGroupRowFieldText(
  ...
  public abstract getChartDefinition(
    title: string,
    securityPositionGrandSummary: U
  ): any;
}
