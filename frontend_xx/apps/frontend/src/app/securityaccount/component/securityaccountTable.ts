...
export abstract class SecurityaccountTable extends SecurityaccountBaseTable {
  ...
  protected constructor(
    ...
    this.groupMapping.set(
      ...
      new SecurityaccountAssetclassSubCategoryGroup(
        this.gps,
    ...
    this.groupMapping.set(
      SecurityAccountGroup[
        SecurityAccountGroup.GROUP_BY_ASSETCLASS_COMBINATION
      ],
    ...
    this.securityaccountGroupBase = new SecurityaccountCurrencyGroup(
      translateService,
      this
    );
    this.createColumns();
  ...
  protected getTitleChart(): string {
    return this.groupOptions.find((item) => item.value === this.selectedGroup)
      .label;
  }
