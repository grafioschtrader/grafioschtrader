 ...
 *
 * This message is broadcast to all connected domains to inform them that the server will be permanently shut down as of
 * the specified date. Until that date the sender keeps being used normally; from it the recipient puts the sender to
 * {@code SOS_OUT_OF_SERVICE}, which is terminal — the peer is never contacted again and an administrator can then
