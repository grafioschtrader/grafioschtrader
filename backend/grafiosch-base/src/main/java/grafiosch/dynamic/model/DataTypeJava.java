...
/**
 * Enumeration that provides mapping between Java data types and form generation types. This enum is used to identify
 * and categorize Java class types for the purpose of generating appropriate form input components and validation rules
 * in dynamic forms.
 *
 * <p>
 * The enum distinguishes between primitive types and their corresponding wrapper classes to ensure accurate type
 * mapping during reflection-based form generation. For example, {@code boolean.class} maps to {@link #Boolean} while
 * {@code Boolean.class} maps to {@link #BooleanC}.
 * </p>
 */
