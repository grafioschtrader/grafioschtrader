 ...
 *
 * <p>
 * When an admin exceeds security breach or request limit thresholds, they cannot approve their own release request
 * through the normal ProposeUserTask flow. This error signals the frontend to show a self-release confirmation dialog
 * instead of the regular "write a note to admin" dialog.
 * </p>
 */
