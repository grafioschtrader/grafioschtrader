 ...
 *
 * <p>
 * This class is used during CSV import to associate each column in the CSV file with its corresponding field in the
 * target entity class. It stores:
 * <ul>
 ...
 *
 * <p>
 * The mapping is typically created by {@link CSVImportHelper#getHeaderFieldNameMapping} based on matching CSV header
 * names to entity field names.
 *
 * @see CSVImportHelper
