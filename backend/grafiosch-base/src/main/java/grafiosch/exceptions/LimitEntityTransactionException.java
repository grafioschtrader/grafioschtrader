 ...
 *
 * <p>
 * This exception is raised when users attempt to perform more transactions on a specific entity type than allowed by
 * the configured limits. It carries detailed error information about the limit violation for proper exception handling
...
public class LimitEntityTransactionException extends RuntimeException {
   ...
   *
   * <p>
   * Constructs the exception with comprehensive error data that can be used by exception handlers to provide meaningful
   * error responses and appropriate user guidance about transaction limit violations.
   * </p>
   *
