...
public class GeneralNotTranslatedWithArgumentsException extends RuntimeException {
   ...
   *
   * <p>
   * Initializes the exception with all information needed for later message translation. The message key should
   * correspond to an entry in the application's message resource bundles, and the arguments should match the expected
   * parameters for that message template.
   * </p>
   *
   * <p>
   * <strong>Message Template Format:</strong>
   * </p>
   * <p>
   * The message key should reference a template that uses standard message formatting placeholders (e.g., {0}, {1},
   * etc.) that correspond to the provided arguments array.
   * </p>
   *
   * <p>
   ...
   * throw new GeneralNotTranslatedWithArgumentsException("error.user.permission.denied",
