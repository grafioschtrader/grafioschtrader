...
/**
 * This data is returned with a successful login. It is very general data that can be used in different places in the front end. 
 */
public class ConfigurationWithLogin {
   ...
   /**
    * Regular expression to check the password for the security aspect. For example, minimum length of required characters.
    */
   public final boolean passwordRegexOk;
   public final UDFConfig udfConfig = new UDFConfig();

   public ConfigurationWithLogin(List<EntityNameWithKeyName> entityNameWithKeyNameList,
       Map<String, Integer> fieldSize,
  ...
  public static class UDFConfig {
     public Set<String> udfGeneralSupportedEntities = UDFData.UDF_GENERAL_ENTITIES.stream()
