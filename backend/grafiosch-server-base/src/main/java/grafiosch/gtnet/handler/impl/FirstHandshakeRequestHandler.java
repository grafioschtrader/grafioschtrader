...
public class FirstHandshakeRequestHandler extends AbstractGTNetMessageHandler {
  ...
  @Autowired
  private GTNetMessageJpaRepository gtNetMessageJpaRepositoryGT;
  ...
  private void queuePendingMessagesForNewPartner(GTNet myGTNet, GTNet newRemoteGTNet) {
    ...
    List<GTNetMessage> futureMessages = gtNetMessageJpaRepositoryGT.findBySendRecvAndMessageCodeIn(
