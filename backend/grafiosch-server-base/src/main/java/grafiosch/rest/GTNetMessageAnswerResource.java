...
import grafiosch.repository.GTNetMessageAnswerJpaRepository;
import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;

@RestController
@RequestMapping(RequestMappings.GTNET_MESSAGE_ANSWER_MAP)
@Tag(name = RequestMappings.GTNET_MESSAGE_ANSWER, description = "Controller for GTNet message answer auto-response rules")
