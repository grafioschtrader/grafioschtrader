 ...
 */
@Component
public class GNetSettingsBroadcastTask implements ITask {

  private static final Logger log = LoggerFactory.getLogger(GNetSettingsBroadcastTask.class);
  ...
  public void doWork(TaskDataChange taskDataChange) throws TaskBackgroundException {
    if (!globalparametersJpaRepository.isGTNetOperational()) {
      log.debug("GTNet is disabled or has no own entry configured, skipping settings broadcast");
      return;
    }
