 ...
 */
@Component
public class GNetExchangeLogAggregationAndDelGTNetMessagesTask implements ITask {

  private static final Logger log = LoggerFactory.getLogger(GNetExchangeLogAggregationAndDelGTNetMessagesTask.class);
  ...
  public void doWork(TaskDataChange taskDataChange) throws TaskBackgroundException {
    if (!globalparametersJpaRepository.isGTNetOperational()) {
      log.debug("GTNet is disabled or has no own entry configured, skipping log aggregation and message cleanup");
      return;
    }
