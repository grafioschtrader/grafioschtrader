 ...
 *
 * Extends the base repository with trading-specific query methods for GTNetEntity access patterns like finding entities
 * that accept specific request types.
 *
...
public interface GTNetEntityJpaRepository extends GTNetEntityJpaRepositoryBase {
   ...
   *
   * This method is specific to Grafioschtrader's trading functionality where entities can be configured to accept or
   * reject different types of data exchange requests. "Accepting" means acceptRequest > 0 (AC_OPEN or AC_PUSH_OPEN).
   *
