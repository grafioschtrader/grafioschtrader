...
public interface UDFDataJpaRepositoryCustom {
  ...
  /**
   * Retrieves UDFData for a specific user, entity type, and entity ID combination. This method looks up user-defined
   * field data using the composite key consisting of user ID, entity class name, and the specific entity instance ID.
   *
