 ...
 *
 * <p>
 * This repository provides data access operations for user mail forwarding preferences, allowing users to configure how
 * different types of messages are delivered (internal only, external email only, or both). It supports user-specific
 * forwarding rules, message type filtering, and optional message redirection to other users.
 */
