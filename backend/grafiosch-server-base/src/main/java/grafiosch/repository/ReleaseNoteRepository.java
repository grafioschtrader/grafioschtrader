...
/**
 * Repository for managing {@link ReleaseNote} entities. Provides language-filtered queries with pagination for
 * displaying the most recent release notes to users.
 */
public interface ReleaseNoteRepository extends JpaRepository<ReleaseNote, Integer> {

  /**
   * Retrieves release notes for a specific language, ordered by version descending (newest first). Combined with a
   * {@link Pageable} parameter this effectively returns the top N most recent release notes.
   *
