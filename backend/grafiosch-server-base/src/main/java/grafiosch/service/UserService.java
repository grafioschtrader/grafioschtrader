 ...
 *
 * <p>
 * This interface extends Spring Security's UserDetailsService to provide a complete user management solution that
 * handles authentication, authorization, profile management, security monitoring, and user lifecycle operations. It
 * serves as the central service for all user-related functionality in the application.
 * </p>
 *
 * <h3>Core Responsibilities:</h3>
 * <ul>
 * <li><strong>Authentication Integration:</strong> Seamless integration with Spring Security for user authentication
 * and authorization</li>
 * <li><strong>User Lifecycle Management:</strong> Complete user creation, verification, and profile management
 * capabilities</li>
 * <li><strong>Security Monitoring:</strong> Tracking and enforcement of security limits, violations, and protective
 * measures</li>
 * <li><strong>Profile Management:</strong> User preference updates, password changes, and personalization features</li>
 * </ul>
 *
 * <h3>Security Features:</h3>
 * <ul>
 * <li><strong>Limit Enforcement:</strong> Monitors and enforces user-specific security and usage limits to prevent
 * abuse</li>
 * <li><strong>Password Validation:</strong> Comprehensive password policy enforcement with configurable complexity
 * requirements</li>
 * <li><strong>Account Verification:</strong> Email-based account verification workflow for secure user
 * registration</li>
 * <li><strong>Violation Tracking:</strong> Records and tracks security violations for monitoring and protective
 * actions</li>
 * </ul>
 *
 * <h3>Integration Points:</h3>
 * <ul>
 * <li><strong>Spring Security:</strong> Provides UserDetailsService implementation for authentication framework
 * integration</li>
 * <li><strong>JWT Authentication:</strong> Supports token-based authentication with user verification and
 * validation</li>
 * <li><strong>REST Controllers:</strong> Services REST API endpoints for user operations and profile management</li>
 * <li><strong>Security Filters:</strong> Integrates with authentication and authorization filters for request
 * processing</li>
 * </ul>
 *
 * <h3>Data Management:</h3>
 * <p>
 * The service manages user data with support for internationalization, timezone handling, and user preferences while
 * maintaining data integrity and security throughout all operations.
 * </p>
 */
public interface UserService extends UserDetailsService {
   ...
   *
   * <p>
   * This method handles profile updates for the currently authenticated user, allowing modification of email, nickname,
   * and other profile attributes while specifically excluding password changes which require separate security
   * handling.
   * </p>
   *
   * <p>
   ...
   * </p>
   * <p>
   * The method operates on the currently authenticated user from the Spring Security context, ensuring that users can
   * only modify their own profile information.
   * </p>
   *
   * <p>
   * <strong>Supported Updates:</strong>
   * </p>
   * <ul>
   ...
   *
   * <p>
   * This method enforces application-wide security policies by checking user-specific limits for various violation
   * types. If limits are exceeded, appropriate exceptions are thrown to prevent further access and trigger security
   * responses.
   * </p>
   *
   ...
   *
   * <p>
   * This method handles the core user creation process including password encryption, role assignment, and initial
   * account setup. It is typically used as part of the registration workflow after validation and verification
   * processes.
   * </p>
   *
   ...
   *
   * <p>
   * This method handles timezone preference updates to ensure that user interfaces and data display are properly
   * localized to the user's current timezone. The timezone offset is typically updated during login when client
   ...
   *
   * <p>
   * This method implements the complete user registration process including account creation, verification email
   * generation, and email delivery. It handles all aspects of secure user onboarding with email-based account
   * verification.
   * </p>
   *
   * <p>
   ...
   *
   * <p>
   * This method implements secure password change functionality with comprehensive validation including old password
   * verification, new password policy compliance, and demo account protection. It ensures that password changes
   * maintain security standards while preventing unauthorized modifications.
   * </p>
   *
   * <p>
   ...
   *
   * <p>
   * <strong>Demo Account Protection:</strong>
   * </p>
   * <p>
   * The method includes protection against password changes on demonstration accounts to maintain demo environment
   * integrity and prevent security exposure.
   * </p>
   *
   ...
   *
   * <p>
   * This method checks whether a provided password meets the application's security requirements including complexity
   * rules, length requirements, and pattern matching. It supports configurable password policies that can be adjusted
   ...
   *
   * <p>
   * This method tracks various types of user violations and security breaches to maintain application security and
   * enable automated protective responses. Different violation types are tracked separately to provide granular
   * security monitoring.
   * </p>
   *
   * <p>
   * <strong>Tracked Violation Types:</strong>
   * </p>
   * <ul>
   ...
   *
   * <p>
   * This method provides enhanced user loading functionality specifically designed for JWT token validation workflows.
   * It combines user ID lookup with username verification to ensure token integrity and prevent token manipulation
   * attacks.
   * </p>
   *
   ...
   *
   * <p>
   * This method handles localized profile updates for the currently authenticated user, including nickname changes,
   * locale preferences, and UI customization settings. It ensures that user preferences are properly validated and
   * persisted for consistent application behavior.
   * </p>
   *
   ...
   *
   * <p>
   * Used for admin self-release from lockout when the locked-out user is the admin and cannot approve their own release
   * request through the normal ProposeUserTask flow.
   * </p>
   *
