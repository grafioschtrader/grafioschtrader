...
public class SecuritycurrencyGroup {
  ...
  @Schema(description = "Timestamp indicating the last time the data for this group (e.g., prices in a watchlist) was updated.", format = "date-time", example = "2024-07-21T10:30:00")
