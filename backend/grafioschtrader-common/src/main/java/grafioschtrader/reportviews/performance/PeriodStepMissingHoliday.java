 ...
 *
 * <p>
 * This class serves as a base container for period steps that may represent holidays, missing data days, or other
 * non-trading periods within performance analysis windows. It provides the foundation for more specific period step
 * implementations.
 * </p>
 */
