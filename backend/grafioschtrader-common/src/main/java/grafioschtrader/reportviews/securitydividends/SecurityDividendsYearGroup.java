...
/**
* Represents a single year within the dividends report, containing all dividend and interest data for that calendar year.
* 
* <p>
* This class aggregates all financial transactions, positions, and valuations for a specific year, including
* dividend income, interest earnings, fees, taxes, and year-end portfolio valuations. It maintains both
* security positions and cash account positions, with all monetary values converted to the tenant's main currency.
* </p>
*/
...
public class SecurityDividendsYearGroup extends MapGroup<Integer, SecurityDividendsPosition> {
   ...
   * 
   * <p>
   * This method processes both security positions and cash account positions, applying
   * year-end exchange rates for accurate portfolio valuations and aggregating annual
   * totals for dividends, interest, taxes, and transaction costs.
   * </p>
   * 
   ...
   * 
   * <p>
   * This method ensures that securities with open positions appear in the year group
   * even when no buy/sell or dividend transactions occurred. It applies security split
   * adjustments to maintain accurate unit counts across the year.
   * </p>
   * 
