...
public class SecuritycurrencySearch implements Serializable {
  ...
  public String toString() {
    return "SecuritycurrencySearch [isin=" + isin + ", name=" + name + ", nameRegex=" + nameRegex + ", tickerSymbol="
        + tickerSymbol + ", currency=" + currency + ", assetclassType=" + assetclassType
        + ", specialInvestmentInstruments=" + specialInvestmentInstruments + ", subCategoryNLS=" + subCategoryNLS
        + ", onlyTenantPrivate=" + onlyTenantPrivate + ", leverageFactor=" + leverageFactor + ", activeDate="
        + activeDate + "]";
  }
