...
public class AnnualisedPerformance {
  ...
  public static class LastYears {
    ...
    public double getPerformanceYear() {
      return DataBusinessHelper.roundPercentage(performanceYear);
    }

    public double getPerformanceYearMC() {
      return DataBusinessHelper.roundPercentage(performanceYearMC);
    }
  ...
  public static class AnnualisedYears {
    ...
    public double getPerformanceAnnualised() {
      return DataBusinessHelper.roundPercentage(performanceAnnualised);
    }

    public double getPerformanceAnnualisedMC() {
      return DataBusinessHelper.roundPercentage(performanceAnnualisedMC);
    }
