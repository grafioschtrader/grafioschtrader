...
public class FieldDescriptorInputAndShowExtendedSecurity extends FieldDescriptorInputAndShowExtended {
  ...
  public FieldDescriptorInputAndShowExtendedSecurity(EnumSet<AssetclassType> categoryTypeEnums, EnumSet<SpecialInvestmentInstruments> specialInvestmentInstrumentEnums,
      String fieldName, String description, String descriptionHelp, byte uiOrder, DataType dataType, Double min, Double max, Byte udfSpecialType, int idUser) {
