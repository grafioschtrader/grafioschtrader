...
public class CombineTemplateAndImpTransPos {
  ...
  /*
   * public String getFileType() { return ImportTransactionHelper.isCsvEnding(importTransactionPos.getFileNameOriginal(
   * )) ? "C" : ImportTransactionHelper.isPdfEnding(importTransactionPos.getFileNameOriginal( )) &&
