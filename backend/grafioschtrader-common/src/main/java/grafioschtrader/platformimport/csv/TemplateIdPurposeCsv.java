...
/**
 * Projection interface for template import metadata, combining the template’s
 * database identifier, its business purpose, and the numeric template ID
 * parsed from the template text.
 * <p>
 * Typically used with native queries that extract these three values
 * into a DTO-like view.
 */
public interface TemplateIdPurposeCsv {
     ...
     * <p>
     * This value is typically parsed from the raw template string
     * (e.g. via a regular expression) and cast to an integer.
     *
