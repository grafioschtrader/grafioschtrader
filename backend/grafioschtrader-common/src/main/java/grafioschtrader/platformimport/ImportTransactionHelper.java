 ...
 *
 * <p>
 * This abstract helper class contains constants for supported file extensions and utility methods to determine the file
 * type of uploaded transaction documents. The file type determines which import processing pipeline should be used -
 * CSV for tabular data, PDF for individual documents, or TXT for batch-processed documents from GT-PDF-Transform
 * containing multiple converted PDFs.
 * </p>
 *
