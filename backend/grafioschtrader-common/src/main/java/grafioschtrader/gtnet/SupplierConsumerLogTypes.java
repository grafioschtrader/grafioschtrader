...
public enum SupplierConsumerLogTypes {
  ...
  /** Overview logging is enabled. Exchange statistics are recorded to GTNetExchangeLog. */
  SCL_OVERVIEW((byte) 1),

  /** Detailed logging is enabled. Includes overview logging plus detailed price change audit trail. */
  SCL_DETAIL((byte) 2);
