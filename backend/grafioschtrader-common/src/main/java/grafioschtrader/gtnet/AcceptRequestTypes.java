 ...
 *
 * Each GTNetEntity can be configured with one of these acceptance types to control
 ...
 *       This mode is only available for {@link GTNetExchangeKindType#LAST_PRICE} as these instances
 ...
 *
 * @see GTNetExchangeKindType#LAST_PRICE
 */
public enum AcceptRequestTypes {
   ...
   * Only supported for LAST_PRICE exchange kind. These instances are preferred for data
