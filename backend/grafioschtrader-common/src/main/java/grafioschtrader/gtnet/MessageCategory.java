...
public enum MessageCategory {
   ...
   *
   * The response may be immediate (via GTNetMessageAnswer auto-response rules) or deferred (awaiting manual admin
   * review). Examples: handshake requests, entity data requests, lastprice requests.
   */
  REQUEST,
   ...
   * the response and updates GTNet configuration accordingly. No further response is sent.
   */
  RESPONSE,
