...
/**
 * Projection interface for retrieving security or currency-pair information
 * used in task notification contexts.
 * <p>
...
public interface IdSecurityCurrencyPairInfo {
   ...
   * <p>
   * For securities, this may include the name, ticker symbol, and ISIN. For
   * currency pairs, this is formatted as "FROM/TO" (e.g., "EUR/USD").
   *
