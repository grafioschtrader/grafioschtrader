 ...
 * <p>
 * Provides mapping from a link securitycurrency to its formula for price
 * calculation, with an indicator whether the formula is applied to calculate
 * the price.
 */
public interface IFormulaInSecurity {

  /**
   * The identifier of the linked (parent) securitycurrency from which this
   * formula is derived.
   *
  ...
  /**
   * Indicates whether the formula should be used to calculate the security’s
   * price.
   *
