 ...
 *
 * This entity stores end-of-day OHLCV (Open, High, Low, Close, Volume) data for instruments that do NOT exist in the
 * local database. For instruments that DO exist locally (determined via JOIN to security/currencypair tables),
 * historical data is stored in the standard {@link Historyquote} table instead.
 *
