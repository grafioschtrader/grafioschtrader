...
/**
 * Service class for extracting and providing the next earnings announcement dates from Yahoo Finance as user-defined
 * fields for securities across all users in the system. This class extends YahooUDFFields to provide automatic
 * extraction of upcoming earnings dates from Yahoo Finance's earnings calendar pages.
 *
 * The service performs web scraping of Yahoo Finance earnings calendar data to extract the specific date and time of
 * the next scheduled earnings announcement for each security. This information is crucial for investment timing,
 * portfolio management, and risk assessment around earnings events.
 *
 ...
 *
 * Unlike static link generation, this service performs active data extraction and provides actionable date/time
 * information that can be used for automated decision-making and alerts.
 */
@Service
