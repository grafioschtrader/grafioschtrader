 ...
 * <ul>
 * <li><strong>AC_PUSH_OPEN</strong>: Queries GTNetHistoryquote (for foreign instruments) or local historyquote table
 * (for local instruments), returns records in requested date range</li>
...
public interface HistoryquoteQueryStrategy {
   ...
   * @return list of instruments with their historical price records
   */
  List<InstrumentHistoryquoteDTO> queryCurrencypairs(List<InstrumentHistoryquoteDTO> requested,
