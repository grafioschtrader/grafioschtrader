 ...
 *
 * <p>
 * This interface extends the base repository functionality to provide specialized operations for managing import
 * transaction templates, which define how to parse and interpret financial transaction data from various sources (CSV
 * files, PDF documents). Templates serve as the bridge between raw imported data and structured transaction records,
 * enabling automatic parsing and validation of diverse trading platform formats.
 * </p>
 *
 ...
 * <p>
 * Provides sophisticated template matching capabilities that can parse form data against multiple templates to identify
 * the correct parsing rules and extract transaction information.
 * </p>
 *
 * <h4>Template Management</h4>
 * <p>
 * Supports comprehensive template lifecycle management including creation, validation, export, and bulk upload
 * operations with detailed success/failure reporting.
 * </p>
 *
 * <h4>Localization Support</h4>
 * <p>
 * Enables multi-language template support with locale-aware validation and language selection capabilities for
 * international trading platforms.
 * </p>
 *
 * <h4>Platform Integration</h4>
 * <p>
 * Facilitates integration with various trading platforms by providing template export and import capabilities, allowing
 * template sharing and deployment across environments.
 * </p>
 *
 * <h3>Template Types and Formats</h3>
 * <p>
 * The repository supports templates for different data formats:
 * </p>
 * <ul>
