...
public interface DividendJpaRepositoryCustom {
  ...
  /**
   * Determines from the dividend calendar possible securities that have received a dividend.
   */
  public List<Security> appendThruDividendCalendar();

  /**
   * The following algorithm is used to determine possible missing dividend income in the dividend entity for
   * securities. This is based on the date of the last dividend payment and the periodicity of the expected payments. In
