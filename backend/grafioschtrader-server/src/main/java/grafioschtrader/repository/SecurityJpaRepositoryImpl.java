...
public class SecurityJpaRepositoryImpl extends SecuritycurrencyService<Security, SecurityPositionSummary>
  ...
  public List<Security> findByIsinCurrencyTuples(List<String[]> isinCurrencyPairs) {
    ...
    sql.append("SELECT * FROM security s ");
    sql.append("JOIN securitycurrency sc ON s.id_securitycurrency = sc.id_securitycurrency ");
    ...
    var query = entityManager.createNativeQuery(sql.toString(), Security.class);
