...
public class MyDataExportDeleteDefinition {
  ...
  public static ExportDefinition[] exportDefinitions = new ExportDefinition[] {
      ...
      new ExportDefinition(Stockexchange.TABNAME, TENANT_USER.NONE, null, ExportDefinition.EXPORT_USE | ExportDefinition.CHANGE_USER_ID_FOR_CREATED_BY),
      // Asset classes is fully exported but data owner must be changed too user
      new ExportDefinition(Assetclass.TABNAME, TENANT_USER.NONE, null, ExportDefinition.EXPORT_USE | ExportDefinition.CHANGE_USER_ID_FOR_CREATED_BY),
    
      new ExportDefinition(Portfolio.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(Securitycashaccount.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(Cashaccount.TABNAME, TENANT_USER.NONE, CASHACCOUNT_SELDEL, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      ...
      new ExportDefinition(Securitycurrency.TABNAME, TENANT_USER.ID_TENANT, SECURITYCURRENCY_C_SELECT, ExportDefinition.EXPORT_USE),
      new ExportDefinition(Securitycurrency.TABNAME, TENANT_USER.ID_TENANT, SECURITYCURRENCY_S_SELECT, ExportDefinition.EXPORT_USE),
      ...
      new ExportDefinition(SecurityDerivedLink.TABNAME, TENANT_USER.ID_TENANT, SECURITY_DERIVED_LINK, ExportDefinition.EXPORT_USE),
      new ExportDefinition(Securitysplit.TABNAME, TENANT_USER.ID_TENANT, SECURITYSPLIT_SELECT, ExportDefinition.EXPORT_USE),
      new ExportDefinition(Securitysplit.TABNAME, TENANT_USER.ID_TENANT, SECURITYSPLIT_DELETE, ExportDefinition.DELETE_USE),
      ...
      new ExportDefinition(HistoryquotePeriod.TABNAME, TENANT_USER.ID_TENANT, HISTORYQUOTEPERIOD_SELECT, ExportDefinition.EXPORT_USE),
      new ExportDefinition(HistoryquotePeriod.TABNAME, TENANT_USER.ID_TENANT, HISTORYQUOTEPERIOD_DELETE, ExportDefinition.DELETE_USE),
      ...
      new ExportDefinition(Watchlist.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(Watchlist.TABNAME_SEC_CUR, TENANT_USER.NONE, WATCHLIST_SEC_CUR_SELDEL,
          ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(Transaction.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(ImportTransactionHead.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(ImportTransactionPos.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(ImportTransactionPosFailed.TABNAME, TENANT_USER.NONE, IMPORT_TRANS_FAILED_SELDEL,
          ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
     
      new ExportDefinition(CorrelationSet.TABNAME, TENANT_USER.ID_TENANT, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      ...
      // User defined fields
      new ExportDefinition(UDFMetadata.TABNAME, TENANT_USER.ID_USER, null, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      new ExportDefinition(UDFMetadataSecurity.TABNAME, TENANT_USER.ID_USER, UDF_METADATA_SECUIRTY_SELDEL, ExportDefinition.EXPORT_USE | ExportDefinition.DELETE_USE),
      ...
      new ExportDefinition(AlgoAssetclass.TABNAME, TENANT_USER.ID_TENANT, ALGO_ASSETCLASS_DEL, ExportDefinition.DELETE_USE),
      ...
      new ExportDefinition(AlgoRule.ALGO_RULE_PARAM2, TENANT_USER.ID_TENANT, ALGO_RULE_PARAM_2_DEL, ExportDefinition.DELETE_USE)
