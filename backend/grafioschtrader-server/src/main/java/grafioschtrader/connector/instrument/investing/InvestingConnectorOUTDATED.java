...
/**
 * Since 15 September 2022, this connector no longer works. 
 * Now the API access is protected by Cloudflare. It may be possible to bypass this... 
 * 
 * www.investing.com used manly a single ajax-call to load the data.
 *
 */
// @Component
public class InvestingConnectorOUTDATED extends BaseFeedConnector {
  ...
  public InvestingConnectorOUTDATED() {
