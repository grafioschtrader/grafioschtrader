...
public class FinanzenHelper {
  ...
  static {
    ...
    controllerUrlMapping.put(
      new ControllerUrlMapping(AssetclassType.EQUITIES, SpecialInvestmentInstruments.ETF),
    ...
    controllerUrlMapping.put(
      new ControllerUrlMapping(AssetclassType.FIXED_INCOME, SpecialInvestmentInstruments.ETF),
      new ControllerAssetClass(HIST_FUND_CONTROLLER, INTRA_ETF)
    );
    controllerUrlMapping.put(
    ...
    // — money market
    controllerUrlMapping.put(
      new ControllerUrlMapping(AssetclassType.MONEY_MARKET, SpecialInvestmentInstruments.ETF),
      new ControllerAssetClass(HIST_FUND_CONTROLLER, INTRA_FUND)
    );
    controllerUrlMapping.put(
    ...
    // — real estate
    controllerUrlMapping.put(
      new ControllerUrlMapping(AssetclassType.REAL_ESTATE, SpecialInvestmentInstruments.ETF),
    ...
    controllerUrlMapping.put(
      new ControllerUrlMapping(null, SpecialInvestmentInstruments.NON_INVESTABLE_INDICES),
      new ControllerAssetClass("IndicesController", INTRA_INDEX)
    );
    controllerUrlMapping.put(
      new ControllerUrlMapping(null, SpecialInvestmentInstruments.ISSUER_RISK_PRODUCT),
  ...
  /** 
   * Central lookup: 
   * 1) try [category, instrument] 
   * 2) fallback to [null, instrument] 
   * 3) finally default controller 
   */
