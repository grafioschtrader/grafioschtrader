...
public interface RequestGTMappings {
  ...
  public static final String GTNETEXCHANGE = "gtnetexchange";
  public static final String GTNETEXCHANGE_MAP = RequestMappings.API + GTNETEXCHANGE;
  ...
  public static final String BANKRUPTSECURITY = "bankruptsecurity";
  public static final String BANKRUPTSECURITY_MAP = RequestMappings.API + BANKRUPTSECURITY;
