...
public class ImportTransactionPosResource {
  ...
  @Operation(summary = "Retrieve import transaction positions with template information for a transaction head", description = """
      ...
      parsing templates used to extract the information from the original source files.""", tags = {
  ...
  @Operation(summary = "Assign a security to multiple import transaction positions", description = """
      ...
      of the correct security to the transaction positions.""", tags = { RequestGTMappings.IMPORTTRANSACTIONPOS })
  ...
  @Operation(summary = "Assign a cash account to multiple import transaction positions", description = """
      ...
      assignment of the correct cash account to the transaction positions.""", tags = {
      RequestGTMappings.IMPORTTRANSACTIONPOS })
  ...
  @Operation(summary = "Adjust currency exchange rates or quotations to match broker calculations", description = """
      ...
      match the broker's total values, resolving minor calculation differences due to rounding.""", tags = {
      RequestGTMappings.IMPORTTRANSACTIONPOS })
  ...
  @Operation(summary = "Accept calculated total differences for import transactions", description = """
      ...
      caused by rounding differences or data precision limitations.""", tags = {
      RequestGTMappings.IMPORTTRANSACTIONPOS })
  ...
  @Operation(summary = "Delete multiple import transaction positions", description = """
      ...
      have not been converted to permanent transactions can be deleted.""", tags = {
      RequestGTMappings.IMPORTTRANSACTIONPOS })
  ...
  @Operation(summary = "Set duplicate transaction handling for import positions", description = """
      ...
      transactions when similar transactions already exist in the system.""", tags = {
      RequestGTMappings.IMPORTTRANSACTIONPOS })
  ...
  @Operation(summary = "Create permanent transactions from validated import positions", description = """
      ...
      converted.""", tags = { RequestGTMappings.IMPORTTRANSACTIONPOS })
