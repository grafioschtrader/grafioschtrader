...
@RestController
@RequestMapping(RequestGTMappings.TRADINGDAYSPLUS_MAP)
@Tag(name = RequestGTMappings.TRADINGDAYSPLUS, description = "Controller for trading days plus")
public class TradingDaysPlusResource {
  ...
  @Operation(summary = "Returns all possible tranding days of year", description = "", tags = {
      RequestGTMappings.TRADINGDAYSPLUS })
