...
import grafioschtrader.repository.GTNetConfigEntityJpaRepository;
 ...
 */
@RestController
@RequestMapping(RequestGTMappings.GTNETCONFIGENTITY_MAP)
@Tag(name = RequestGTMappings.GTNETCONFIGENTITY, description = "Controller for GTNet entity configuration")
public class GTNetConfigEntityResource extends UpdateCreate<GTNetConfigEntity> {
  ...
  @Operation(summary = "Update GTNetConfigEntity configuration",
      ...
      tags = { RequestGTMappings.GTNETCONFIGENTITY })
