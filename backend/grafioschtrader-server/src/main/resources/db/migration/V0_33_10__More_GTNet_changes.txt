...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 21. Dez 2025 um 14:24
...
ALTER TABLE `gt_net_config`
  ADD PRIMARY KEY (`id_gt_net_config`);

--
-- Indizes für die Tabelle `gt_net_config_entity`
--
ALTER TABLE `gt_net_config_entity`
  ADD KEY `FK_GtNetConfigEntity_GtNetConfig` (`id_gt_net_config`),
  ADD KEY `FK_GtNetConfigEntity_GtNetEntity_GtNetEntity` (`id_gt_net_entity`);
...
--
-- AUTO_INCREMENT für Tabelle `gt_net_config`
--
ALTER TABLE `gt_net_config`
  MODIFY `id_gt_net_config` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `gt_net_config_entity`
  ADD CONSTRAINT `FK_GtNetConfigEntity_GtNetConfig` FOREIGN KEY (`id_gt_net_config`) REFERENCES `gt_net_config` (`id_gt_net_config`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_GtNetConfigEntity_GtNetEntity_GtNetEntity` FOREIGN KEY (`id_gt_net_entity`) REFERENCES `gt_net_entity` (`id_gt_net_entity`) ON UPDATE CASCADE;
