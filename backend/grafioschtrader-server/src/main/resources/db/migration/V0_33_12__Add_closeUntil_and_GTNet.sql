...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 04. Jan 2026 um 10:30
...
INSERT INTO globalparameters SET property_name = 'gt.gtnet.my.entry.id', changed_by_system = 1;
...
ALTER TABLE securitycurrency DROP COLUMN IF EXISTS gt_net_lastprice_recv;
ALTER TABLE securitycurrency DROP COLUMN IF EXISTS gt_net_historical_recv;
ALTER TABLE securitycurrency DROP COLUMN IF EXISTS gt_net_lastprice_send;
ALTER TABLE securitycurrency DROP COLUMN IF EXISTS gt_net_historical_send;
ALTER TABLE securitycurrency DROP COLUMN IF EXISTS gt_net_last_modified_time;

ALTER TABLE securitycurrency ADD gt_net_lastprice_recv TINYINT(1) NOT NULL DEFAULT '0' AFTER s_high, 
ADD gt_net_historical_recv TINYINT(1) NOT NULL DEFAULT '0' AFTER gt_net_lastprice_recv, 
ADD gt_net_lastprice_send TINYINT(1) NOT NULL AFTER gt_net_historical_recv, 
...
CREATE TABLE `gt_net_entity` (
  ...
  `enable_log` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `gt_net_exchange_log`
--
...
--
-- Tabellenstruktur für Tabelle `gt_net_historyquote`
--

CREATE TABLE `gt_net_historyquote` (
  `id_gt_net_historyquote` int(11) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `gt_net_instrument`
--
...
--
-- Tabellenstruktur für Tabelle `gt_net_instrument_currencypair`
--
...
--
-- Tabellenstruktur für Tabelle `gt_net_instrument_security`
--
...
--
-- Indizes für die Tabelle `gt_net_historyquote`
--
ALTER TABLE `gt_net_historyquote`
  ADD PRIMARY KEY (`id_gt_net_historyquote`),
  ADD UNIQUE KEY `UK_GtNetHistoryquote_InstrumentDate` (`id_gt_net_instrument`,`date`);

--
-- Indizes für die Tabelle `gt_net_instrument`
--
ALTER TABLE `gt_net_instrument`
  ADD PRIMARY KEY (`id_gt_net_instrument`),
  ADD KEY `FK_GtNetInstrument_GtNet` (`id_gt_net`),
  ADD KEY `FK_GtNetInstrument_Securitycurrency` (`id_securitycurrency`);

--
-- Indizes für die Tabelle `gt_net_instrument_currencypair`
--
ALTER TABLE `gt_net_instrument_currencypair`
  ADD PRIMARY KEY (`id_gt_net_instrument`),
  ADD UNIQUE KEY `UK_GtNetInstrumentCp_FromTo` (`from_currency`,`to_currency`);

--
-- Indizes für die Tabelle `gt_net_instrument_security`
--
ALTER TABLE `gt_net_instrument_security`
  ADD PRIMARY KEY (`id_gt_net_instrument`),
  ADD UNIQUE KEY `UK_GtNetInstrumentSec_IsinCurrency` (`isin`,`currency`);
...
ALTER TABLE `gt_net_lastprice`
  ...
  ADD UNIQUE KEY `UK_GtNetLastprice_Instrument` (`id_gt_net_instrument`);
...
--
-- AUTO_INCREMENT für Tabelle `gt_net_exchange_log`
--

--
-- AUTO_INCREMENT für Tabelle `gt_net_historyquote`
--
ALTER TABLE `gt_net_historyquote`
  MODIFY `id_gt_net_historyquote` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT für Tabelle `gt_net_instrument`
--
ALTER TABLE `gt_net_instrument`
  MODIFY `id_gt_net_instrument` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints der Tabelle `gt_net_exchange_log`
--
ALTER TABLE `gt_net_exchange_log`
  ADD CONSTRAINT `FK_GtNetExchangeLog_GtNet` FOREIGN KEY (`id_gt_net`) REFERENCES `gt_net` (`id_gt_net`);

--
-- Constraints der Tabelle `gt_net_historyquote`
--
ALTER TABLE `gt_net_historyquote`
  ADD CONSTRAINT `FK_GtNetHistoryquote_Instrument` FOREIGN KEY (`id_gt_net_instrument`) REFERENCES `gt_net_instrument` (`id_gt_net_instrument`);

--
-- Constraints der Tabelle `gt_net_instrument`
--
ALTER TABLE `gt_net_instrument`
  ADD CONSTRAINT `FK_GtNetInstrument_GtNet` FOREIGN KEY (`id_gt_net`) REFERENCES `gt_net` (`id_gt_net`),
  ADD CONSTRAINT `FK_GtNetInstrument_Securitycurrency` FOREIGN KEY (`id_securitycurrency`) REFERENCES `securitycurrency` (`id_securitycurrency`);

--
-- Constraints der Tabelle `gt_net_instrument_currencypair`
--
ALTER TABLE `gt_net_instrument_currencypair`
  ADD CONSTRAINT `FK_GtNetInstrumentCp_Instrument` FOREIGN KEY (`id_gt_net_instrument`) REFERENCES `gt_net_instrument` (`id_gt_net_instrument`);

--
-- Constraints der Tabelle `gt_net_instrument_security`
--
ALTER TABLE `gt_net_instrument_security`
  ADD CONSTRAINT `FK_GtNetInstrumentSec_Instrument` FOREIGN KEY (`id_gt_net_instrument`) REFERENCES `gt_net_instrument` (`id_gt_net_instrument`);

--
-- Constraints der Tabelle `gt_net_lastprice`
--
ALTER TABLE `gt_net_lastprice`
  ADD CONSTRAINT `FK_GtNetLastprice_Instrument` FOREIGN KEY (`id_gt_net_instrument`) REFERENCES `gt_net_instrument` (`id_gt_net_instrument`);
