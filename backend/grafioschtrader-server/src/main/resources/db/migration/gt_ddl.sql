...
) ENGINE=InnoDB AUTO_INCREMENT=6393 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `correlation_instrument` (
  ...
  CONSTRAINT `FK_CorrInstrument_CorrSet` FOREIGN KEY (`id_correlation_set`) REFERENCES `correlation_set` (`id_correlation_set`),
...
CREATE TABLE `dividend` (
  ...
  `amount` double(16,7) DEFAULT NULL,
  `amount_adjusted` double(16,7) DEFAULT NULL,
  `currency` char(3) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=6073314 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='Certain securities do not have public and daily prices. For example, time deposits, but a daily price is still required for the holding period.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30841 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20609 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `securitycurrency` (
  ...
  `next_history_planned` timestamp NULL DEFAULT NULL,
  `last_history_try` timestamp NULL DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=133147 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-27  7:47:50
