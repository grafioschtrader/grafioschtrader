...
public class ViennaStockExchangeFeedConnectorTest {
  ...
  private List<SecurityHisoricalDate> getHistoricalSecurities() throws ParseException {
    List<SecurityHisoricalDate> hisoricalDate = new ArrayList<>();
    hisoricalDate.add(new SecurityHisoricalDate("ANDRITZ AG", "AT0000730007",
    ...
    hisoricalDate.add(
        new SecurityHisoricalDate("3 Banken Anleihefonds-Selektion", "AT0000744594", SpecialInvestmentInstruments.MUTUAL_FUND,
            AssetclassType.FIXED_INCOME, "8595610", null, 3755, "2004-11-04", "2023-01-09"));
    hisoricalDate
        .add(new SecurityHisoricalDate("ATX Index", "AT0000999982", SpecialInvestmentInstruments.NON_INVESTABLE_INDICES,
    ...
    hisoricalDate.add(
        new SecurityHisoricalDate("Land NOE var. Schuldv. 13-28", "AT0000A11772", SpecialInvestmentInstruments.DIRECT_INVESTMENT,
            AssetclassType.FIXED_INCOME, "90108510", null, 21, "2022-12-05", "2023-01-09"));
    hisoricalDate.add(new SecurityHisoricalDate("iShares EURO STOXX 50 U.ETF", "IE0008471009", SpecialInvestmentInstruments.ETF,
