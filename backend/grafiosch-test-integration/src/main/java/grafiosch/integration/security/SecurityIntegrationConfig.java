 ...
 *
 * <p>
 * {@code @EnableMethodSecurity} mirrors {@code SecurityGTConfig}: the {@code @PreAuthorize} annotated GTNet resources
 * live in {@code grafiosch-server-base}, so without it the library stack would leave them unprotected while the
 * application stack enforces them.
 * </p>
 */
@Configuration
@EnableWebSecurity
