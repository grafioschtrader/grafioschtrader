 ...
 * {@code testdata/users.csv}, {@code users} / {@code ALL_USERS} / {@code LIMIT_USERS}, {@code getUserByNickname} and
 * {@code inizializeUserTokens} — is inherited from {@link RestTestHelperBase} and stays reachable through this class
 * name.
 *
 * <p>
 * Only the nickname constants of this module's {@code users.csv} live here. They mirror the Grafioschtrader fixture so
